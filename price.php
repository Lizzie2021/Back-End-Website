<?php
    ...
    $price_min = floatval($_GET['min']);
    $price_max = floatval($_GET['max']);
    $result = $crud->getProductsByPrice($price_min,$price_max);
?>
 <div class="container">
    ...
    <div class="container">
      <div class="row">
        ...
        <?php $result = $crud->getProductsByPrice($price_min,$price_max);?>
